...
$(function(){(new WOW).init(),$(".overlay, footer").mousemove(function(e){var t=-1*e.pageX/25,o=-1*e.pageY/25;$(this).css("background-position",t+"px "+o+"px")}),$(".main-nav .navbar-header .hamburger").on("click",function(){$(this).toggleClass("is-active")}),$(".main-nav").affix({offset:{top:function(){return $("header").outerHeight()}}}),$(".skill-button").on("click",function(){$(this).next().slideToggle()}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1}),$(".main-nav a").mPageScroll2id(),$(".button-to-top .btn-top").mPageScroll2id(),$("header a").mPageScroll2id(),$("#question .btn-hire").mPageScroll2id(),$(window).scroll(function(){$(this).scrollTop()>$("header").outerHeight()?$(".button-to-top").addClass("active"):$(".button-to-top").removeClass("active")})}),$(window).on("load",function(){$(".loader_inner").fadeOut(),$(".loader").delay(400).fadeOut("slow")});